...
- [v1.3.4](https://github.com/dain98/clipline-cloud/releases/tag/v1.3.4)
- `ghcr.io/dain98/clipline-cloud:1.3.4`
...
released tag such as `1.3.4` when you want explicit upgrade and rollback control.
