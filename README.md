...
- [v1.3.5](https://github.com/dain98/clipline-cloud/releases/tag/v1.3.5)
- `ghcr.io/dain98/clipline-cloud:1.3.5`
...
released tag such as `1.3.5` when you want explicit upgrade and rollback control.
