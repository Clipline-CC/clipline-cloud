...
`||n==="\r"?(l(),o=2):i+=n),o===3&&i==="!--"&&(o=4,d=d[0])}return l(),d})(e)),t),arguments,[])).length>1?t:t[0]}var s=Ta.bind(wt);se();function Ma(e){let t=e,a=new Set;return{get:()=>t,set(n){t=n,a.forEach(r=>r(t))},update(n){this.set(n(t))},subscribe(n){return a.add(n),()=>a.delete(n)}}}function Z(e){let[t,a]=b(e.get());return E(()=>e.subscribe(a),[e]),t}var N=Ma({user:null,csrfToken:null,ready:!1}),tt=Ma([]),Qn=0;function v(e,{actionLabel:t,onAction:a,timeoutMs:n=5e3}={}){let r=++Qn;return tt.update(o=>[...o,{id:r,message:e,actionLabel:t,onAction:a}]),n&&setTimeout(()=>at(r),n),r}function at(e){tt.update(t=>t.filter(a=>a.id!==e))}function Le(e){try{return decodeURIComponent(e)}catch{return e}}function Ra(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Yn=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function Rt(e){return Yn.includes(e)}function Ea(e,t){return!t&&!Rt(e)}var Xn={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"};function Et(e){return Xn[e?.name]||""}function Ua(e){return e?.name==="publicLibrary"&&e.surface==="search"?"search":Et(e)}function Ne(e,t){let a=new URLSearchParams(t||""),n=e;return n.startsWith("/c/")?{name:"public",shareId:Le(n.slice(3))}:n==="/"||n==="/public"||n==="/search"?{name:"publicLibrary",query:Ra(a),surface:n==="/search"?"search":"feed"}:n.startsWith("/game/")?{name:"publicGame",game:Le(n.slice(6)),query:Ra(a)}:n==="/about"?{name:"about"}:n==="/games"?{name:"games"}:n.startsWith("/u/")?{name:"publicUser",username:Le(n.slice(3))}:n==="/library"?{name:"library"}:n.startsWith("/clip/")?{name:"clip",clipId:Le(n.slice(6))}:n==="/admin/game-categories"?{name:"admin",tab:"categories"}:n.startsWith("/admin/game-categories/")?{name:"admin",tab:"categories",categoryId:Le(n.slice(23))}:n==="/admin"?{name:"admin",tab:a.get("tab")||"overview"}:n==="/account"?{name:"account"}:n==="/profile"?{name:"profile"}:n==="/login"?{name:"login"}:n==="/reset-password"?{name:"resetPassword",token:a.get("token")||"",invite:a.get("invite")==="1"}:{name:"publicLibrary"}}var Ut=new Set;function K(e){window.history.pushState({},"",e),Da()}function Da(){let{pathname:e,search:t}=window.location,a=Ne(e,t);Ut.forEach(n=>n(a))}typeof window<"u"&&window.addEventListener("popstate",Da);function Ia(){let[e,t]=b(()=>Ne(window.location.pathname,window.location.search));return E(()=>(Ut.add(t),()=>Ut.delete(t)),[]),e}function Aa(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),K(t.getAttribute("href")))}var La={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',arrowLeft:'<path d="m15 18-6-6 6-6"/><path d="M9 12h12"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function C(e,{size:t=18}={}){return s`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
  ...
  </header>`}async function rr(){let{api:e,setCsrfToken:t}=await Promise.resolve().then(()=>(se(),Pa));try{await e("/api/v1/auth/logout",{method:"POST"})}catch{}t(null),N.set({user:null,csrfToken:null,ready:!0}),K("/login")}var or=[["feed","/","home","Feed",!0],["games","/games","globe","Games",!0],["library","/library","library","Library","auth"],["search","/search","search","Search",!0],["profile","/profile","user","Profile","auth"]];function sr(e){return or.filter(([,,,,t])=>t!=="auth"||!!e)}function Ba({active:e}){let{user:t}=Z(N),a=sr(t);return s`<nav class="tabbar" aria-label="Primary">
    ${a.map(([n,r,o,i])=>s`
    ...
    <section class="hero">
      ...
      <div class="hero-side">
        ${n.map(r=>s`<a class="hero-row" href=${Lt(r)}>
            ...
            <span class="hero-copy"><b>${r.title}</b>
              <small>${At(r)} · ${qa(r)} · ${Pe(r.view_count)}</small></span>
          </a>`)}
      </div>
  ...
  </nav>`}function Ga(){let{data:e,error:t}=ie("/api/v1/public/games"),a=e?.games??null;return t?s`<main class="page">
  ...
  </main>`}se();function ja({trigger:e,content:t,onClose:a,label:n,panelClass:r=""}){let[o,i]=b(!1),c=z(null),d=z(null),l=z(null),p=()=>{i(!1),a?.()},h=()=>{if(o){p();return}l.current=document.activeElement,i(!0)};return E(()=>{if(!o)return;let u=w=>{c.current?.contains(w.target)||p()},f=w=>{w.key==="Escape"&&p()};return document.addEventListener("pointerdown",u),document.addEventListener("keydown",f),d.current?.querySelector("input, select, textarea, button, a[href], [tabindex]")?.focus(),()=>{document.removeEventListener("pointerdown",u),document.removeEventListener("keydown",f),l.current?.focus?.()}},[o]),s`<div class="popover-wrap" ref=${c}>
    ${e({open:o,toggle:h})}
    ${o&&s`<div class=${`popover ${r}`} ref=${d} role="dialog" aria-label=${n||"Filters"}>
      ${t}
    </div>`}
  </div>`}function Ka({count:e,busy:t=!1,onPublic:a,onPrivate:n,onCopyLinks:r,onDelete:o,onClear:i}){return e?s`<div class="bulkbar" role="toolbar" aria-label="Bulk actions" aria-busy=${t?"true":"false"}>
    <b>${e} selected</b>
  ...
  </div>`:null}function le({open:e,title:t,body:a,confirmLabel:n="Confirm",onConfirm:r,onCancel:o,danger:i=!1,confirmDisabled:c=!1}){let d=z(null),l=z(null);return E(()=>{let p=d.current;p&&(e&&!p.open?(p.showModal(),l.current?.focus()):!e&&p.open&&p.close())},[e]),s`<dialog ref=${d} class="confirm-dialog" aria-labelledby="confirm-dialog-title"
...
`)),v(`Copied ${L.length} link${L.length===1?"":"s"}`+(_?` (${_} skipped, private)`:""))}catch{v("Couldn't copy links to clipboard.")}}async function ue(){let m=Array.from(i);h(!1);try{let $=await k("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:m}});c(new Set),I(),v(`Deleted ${$.affected} clip${$.affected===1?"":"s"}.`)}catch($){v($.message)}}if(P)return s`<main class="page">
    ...
    <div class="lib-toolbar">
      ...
      <${ja}
        ...
        trigger=${({open:m,toggle:$})=>s`<button type="button" class="btn" aria-haspopup="dialog"
          ...
          ${ne>0&&s`<span class="filter-badge">${ne}</span>`}
        </button>`}
        content=${H} />
    </div>
    ...
    ${oe.length>0&&s`<div class="lib-chips">
      ...
      ${oe.map(m=>s`<button type="button" class=${`chip game-filter-chip ${m.icon_url?"has-icon":""} ${a.game===m.game?"chip-on":""}`}
        ...
        aria-pressed=${a.game===m.game} onClick=${()=>A(m.game)}>
        ${m.icon_url?s`<img src=${m.icon_url} alt="" loading="lazy" />`:m.label}
      </button>`)}
    </div>`}

    ${ae==null?s`<${Tr} />`:ae.length===0?Ce?s`<${Q} name="film" title="No clips match this view"
          ...
          ${ae.map(m=>s`<${Ee} key=${m.id}
            clip=${{...m,thumbnail_url:It(m),media_url:rt(m)}}
            href=${`/clip/${encodeURIComponent(m.id)}`}
            selectable selected=${i.has(m.id)} onToggleSelect=${me} showVisibility />`)}
        </div>`:s`<${xr} clips=${ae} query=${a} onSort=${G}
  ...
  </div>`}se();function Xa(e){let t=Number(e);return Number.isFinite(t)&&t>0?t/1e3:0}function en(e,t){let a=Number.isFinite(e)?e:0,n=t>0?t:Number.MAX_SAFE_INTEGER;return Math.max(0,Math.min(n,a))}function dt(e,t){return t>0?Math.max(0,Math.min(100,e/t*100)):0}function Bt(e){if(!Number.isFinite(e))return"0:00";let t=Math.max(0,Math.round(e)),a=Math.floor(t/60),n=t-a*60;return`${a}:${String(n).padStart(2,"0")}`}function Ya(e){if(!Number.isFinite(e))return"0:00.0";let t=Math.max(0,Math.round(e*10)),a=Math.floor(t/600),n=t-a*600,r=Math.floor(n/10);return`${a}:${String(r).padStart(2,"0")}.${n%10}`}function tn(e,t){return`${Ya(e)} / ${t>0?Ya(t):"0:00.0"}`}function an(e,t){return(e||[]).map((a,n)=>{let r=Number(a.timestamp_ms);if(!Number.isFinite(r))return null;let o=r/1e3;return o<0||t>0&&o>t?null:{index:n,time:o,label:String(a.label||a.kind||"Marker")}}).filter(Boolean).sort((a,n)=>a.time-n.time)}function nn(e,t){if(!e.length)return null;for(let a of e)if(a.time>t+.05)return a;return e[0]}function rn(e,t){if(!e.length)return null;for(let a=e.length-1;a>=0;a-=1)if(e[a].time<t-.05)return e[a];return e[e.length-1]}var sn="clipline.playerVolume",ln="clipline.clipTheaterMode",Pr=2e3,Mr=[.25,.5,.75,1,1.25,1.5,2];function Rr(e,t){switch(e){case"Space":case"KeyK":return{kind:"toggle-play"};case"ArrowLeft":return{kind:"seek-by",seconds:t?-1:-5};case"ArrowRight":return{kind:"seek-by",seconds:t?1:5};case"KeyJ":return{kind:"seek-by",seconds:-10};case"KeyL":return{kind:"seek-by",seconds:10};case"Comma":return{kind:"seek-by",seconds:-.1};case"Period":return{kind:"seek-by",seconds:.1};case"KeyM":return{kind:"toggle-mute"};case"Home":return{kind:"seek-to",seconds:0};case"End":return{kind:"seek-to-end"};case"KeyF":case"KeyT":return{kind:"theater"};case"Escape":return{kind:"exit-theater"};default:return null}}function Er(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, [contenteditable='true'], [contenteditable='']"):!1}function Ur(){try{let e=window.localStorage.getItem(sn);if(e==null)return 1;let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):1}catch{return 1}}async function Dr(e,{isCancelled:t,onMuted:a,onError:n}={}){let r=t||(()=>!1);if(!r()){try{await e.play();return}catch{if(r()||!e.paused)return}e.muted=!0,a?.();try{await e.play()}catch(o){r()||n?.(o)}}}function on(e){try{window.localStorage.setItem(sn,String(Math.max(0,Math.min(1,e))))}catch{}}function Ir(){try{return window.localStorage.getItem(ln)==="true"}catch{return!1}}function Ar(e){try{window.localStorage.setItem(ln,String(e))}catch{}}function cn({src:e,poster:t,durationMs:a,markers:n}){let r=z(null),o=z(null),i=z(null),c=z(!1),d=z(!1),l=Xa(a),[p,h]=b(!1),[u,f]=b(0),[g,w]=b(l),[P,R]=b(0),[S,D]=b(Ur),[O,I]=b(!1),[U,q]=b(1),[V,Y]=b(!1),[A,G]=b(Ir),[_e,me]=b(!0),[re,ke]=b(null),[te,X]=b(""),ce=an(n,g);function ue(){me(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{let _=r.current;_&&!_.paused&&!_.ended&&me(!1)},Pr)}E(()=>{p||(window.clearTimeout(i.current),me(!0))},[p]),E(()=>{let _=r.current;if(!_)return;let x=()=>Number.isFinite(_.duration)&&_.duration>0?_.duration:l,T=()=>w(x()),de=()=>w(x()),he=()=>{c.current||f(_.currentTime||0)},pe=()=>{let Wt=x();if(!(Wt>0)||!_.buffered?.length){R(0);return}let Zt=_.currentTime||0,Oe=0;for(let Ve=0;Ve<_.buffered.length;Ve+=1){let An=_.buffered.start(Ve),ht=_.buffered.end(Ve);if(Zt>=An&&Zt<=ht){Oe=ht;break}Oe=Math.max(Oe,ht)}R(dt(Oe,Wt))},Ue=()=>{h(!0),X(""),ue()},qt=()=>h(!1),Gt=()=>h(!1),jt=()=>{D(_.volume),I(_.muted||_.volume===0)},Kt=()=>X("Playback unavailable");return _.addEventListener("loadedmetadata",T),_.addEventListener("durationchange",de),_.addEventListener("timeupdate",he),_.addEventListener("progress",pe),_.addEventListener("play",Ue),_.addEventListener("pause",qt),_.addEventListener("ended",Gt),_.addEventListener("volumechange",jt),_.addEventListener("error",Kt),()=>{_.removeEventListener("loadedmetadata",T),_.removeEventListener("durationchange",de),_.removeEventListener("timeupdate",he),_.removeEventListener("progress",pe),_.removeEventListener("play",Ue),_.removeEventListener("pause",qt),_.removeEventListener("ended",Gt),_.removeEventListener("volumechange",jt),_.removeEventListener("error",Kt)}},[e,l]),E(()=>{r.current&&(r.current.volume=S)},[S]),E(()=>{r.current&&(r.current.muted=O)},[O]),E(()=>{r.current&&(r.current.playbackRate=U)},[U]),E(()=>{let _=r.current;if(!_)return;let x=!1;return Dr(_,{isCancelled:()=>x,onMuted:()=>I(!0),onError:T=>X(T?.message||"Playback unavailable")}),()=>{x=!0}},[e]),E(()=>{let _=document.documentElement;return _.classList.toggle("clipline-theater",A),()=>_.classList.remove("clipline-theater")},[A]);function ae(_){G(_),Ar(_)}function ne(_){let x=r.current;if(!x)return;let T=g>0?en(_,g):Math.max(0,_);x.currentTime=T,f(T)}function Ce(_){ne((r.current?.currentTime||0)+_)}async function oe(){let _=r.current;if(_)if(_.paused||_.ended)try{await _.play()}catch(x){X(x?.message||"Playback failed")}else _.pause()}function be(){let _=r.current;_&&(_.muted||_.volume===0?(_.muted=!1,_.volume===0&&(_.volume=1,D(1),on(1)),I(!1)):(_.muted=!0,I(!0)))}function Te(_){let x=Number(_.target.value);D(x),I(x===0),on(x);let T=r.current;T&&(T.volume=x,T.muted=x===0)}async function fe(){try{document.fullscreenElement?await document.exitFullscreen():await o.current?.requestFullscreen?.()}catch(_){X(_?.message||"Fullscreen unavailable")}}function y(_){let x=r.current?.currentTime||0,T=_>0?nn(ce,x):rn(ce,x);T&&ne(T.time)}function H(){c.current=!0,d.current=p,p&&r.current?.pause()}function m(_){let x=Number(_.target.value);f(x),ne(x)}function $(){c.current&&(c.current=!1,d.current&&(d.current=!1,r.current?.play().catch(()=>{})))}function M(_){let x=_.currentTarget.getBoundingClientRect();if(!(x.width>0))return;let T=Math.max(0,Math.min(1,(_.clientX-x.left)/x.width));ke({pct:T*100,time:T*(g||0)})}function L(){ke(null)}return E(()=>{function _(x){if(x.defaultPrevented||Er(x.target))return;let T=Rr(x.code,x.shiftKey);if(T&&!(T.kind==="exit-theater"&&!A))switch(x.preventDefault(),ue(),T.kind){case"toggle-play":oe();break;case"seek-by":Ce(T.seconds);break;case"seek-to":ne(T.seconds);break;case"seek-to-end":ne(g);break;case"toggle-mute":be();break;case"theater":ae(!A);break;case"exit-theater":ae(!1);break}}return document.addEventListener("keydown",_),()=>document.removeEventListener("keydown",_)},[g,A,p]),s`<div class=${`player ${_e?"":"chrome-hidden"}`} ref=${o}
    ...
    ${te&&s`<div class="player-note">${te}</div>`}
    <div class="player-overlay">
      ...
      <div class="player-controls">
        ...
        <button type="button" class="player-btn" aria-label=${A?"Exit theater mode":"Theater mode"}
          aria-pressed=${A} onClick=${()=>ae(!A)}>${C("theater",{size:14})}</button>
        <button type="button" class="player-btn" aria-label="Fullscreen" onClick=${fe}>
          ${C("fullscreen",{size:14})}
        </button>
      </div>
    </div>
  </div>`}se();function Lr(e){let t=new Map(e.map(o=>[o.id,o])),a=new Map,n=[],r=0;return e.forEach(o=>{let i=o.parent_comment_id||"";i&&t.has(i)?(a.has(i)||a.set(i,[]),a.get(i).push(o),r+=1):i||(n.push(o),r+=1)}),{roots:n,repliesByParent:a,count:r}}async function Nr({apiClient:e=k,shareId:t,body:a,parentCommentId:n,onReload:r=()=>{},onError:o=v}){let i=a.trim();if(!i)return!1;try{return await e(`/api/v1/public/clips/${encodeURIComponent(t)}/comments`,{method:"POST",body:n?{body:i,parent_comment_id:n}:{body:i}}),r(),!0}catch(c){return o(c.message),!1}}function Br(e){return(e||"?").trim().slice(0,1).toUpperCase()||"?"}function zr(e){let t=Dt(e.author_avatar_url);return t?s`<img class="comment-avatar" src=${t} alt="" />`:s`<div class="comment-avatar">${Br(e.author_name)}</div>`}function un({shareId:e}){let{user:t}=Z(N),[a,n]=b(0),[r,o]=b(""),[i,c]=b(null),[d,l]=b(""),[p,h]=b(null),u=`/api/v1/public/clips/${encodeURIComponent(e)}/comments`,{data:f,error:g}=ie(u,a),w=g?[]:f?.comments??null;function P(){n(U=>U+1)}async function R(U,q){return Nr({shareId:e,body:U,parentCommentId:q,onReload:P,onError:v})}async function S(U){U.preventDefault(),await R(r)&&o("")}async function D(U,q){U.preventDefault(),await R(d,q)&&(l(""),c(null))}async function O(){let U=p;h(null);try{await k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments/${encodeURIComponent(U)}`,{method:"DELETE"}),P()}catch(q){v(q.message)}}let I=Lr(w||[]);return s`<section class="comments">
  ...
  </article>`}var Fr=["private","public","unlisted"];function Or(e,t){return e==="clip"?!0:!!t?.viewer_can_edit}function Vr(e,t,a){return e==="public"?t.shareId:a?.public_share_id||null}function Hr(e,t,a){return e==="clip"?t.clipId:a?.viewer_clip_id||null}function qr(e){let t=e?.height!=null?e.height:"",a=Math.round(e?.fps||0)||"";return`${t}p${a}`}function Gr(e,t=8){let a=new URLSearchParams;return e&&a.set("share_id",e),a.set("limit",String(t)),`/api/v1/public/recommendations?${a}`}function jr(e,t,a=8){return(e||[]).filter(n=>n.share_id!==t).slice(0,a)}function Kr(e,t,a){let n=e==="clip"?a||{}:{display_name:t?.author_name||null,username:t?.author_username||null,avatar_url:t?.author_avatar_url||null},r=n.username||null;return{label:n.display_name||r||"Unknown creator",username:r,href:r?`/u/${encodeURIComponent(r)}`:null,avatarUser:n}}function Wr({author:e}){let t=s`
    <${xe} user=${e.avatarUser} size=${36} />
    <span class="watch-author-name">${e.label}</span>
  `,a=e.href?s`<a class="watch-author-link" href=${e.href}>${t}</a>`:s`<span class="watch-author-link watch-author-static">${t}</span>`;return s`<div class="watch-author-row">${a}</div>`}function zt({route:e}){let{user:t}=Z(N),[a,n]=b(null),[r,o]=b(null),[i,c]=b([]),[d,l]=b(!1),[p,h]=b(""),[u,f]=b(!1),[g,w]=b(""),[P,R]=b(!1),[S,D]=b(!1),[O,I]=b(!1),U=e.name==="clip"?`clip:${e.clipId}`:`public:${e.shareId}`,q=Vr(e.name,e,a),V=e.name==="public"||!!a;if(E(()=>{let y=new AbortController;n(null),o(null),l(!1),f(!1),I(!1),R(!1);let H=e.name==="clip"?`/api/v1/clips/${encodeURIComponent(e.clipId)}`:`/api/v1/public/clips/${encodeURIComponent(e.shareId)}`;return k(H,{signal:y.signal}).then(m=>{n(m),e.name==="public"&&k(`/api/v1/public/clips/${encodeURIComponent(e.shareId)}/view`,{method:"POST",body:{},signal:y.signal}).then($=>n(M=>M&&{...M,view_count:$.view_count})).catch(()=>{})}).catch(m=>{m?.name!=="AbortError"&&o(m)}),()=>y.abort()},[U]),E(()=>{if(!V){c([]);return}let y=new AbortController;return c([]),k(Gr(q,8),{signal:y.signal}).then(H=>c(H.clips||[])).catch(()=>{}),()=>y.abort()},[U,q,V]),r)return s`<main class="page"><${Q} name="alert" title="Couldn't load this clip" body=${r.message} /></main>`;if(!a)return s`<main class="page watch"><div><div class="skeleton-thumb"></div></div><aside class="upnext"></aside></main>`;let Y=Or(e.name,a),A=q,G=Hr(e.name,e,a),_e=e.name==="clip"?rt({id:a.id}):Re({share_id:e.shareId}),me=e.name==="clip"?Fa({id:a.id}):ot({share_id:e.shareId}),re=Kr(e.name,a,t),ke=a.public_url??a.share_url??null,te=ze(ke,window.location.origin,A),X=e.name==="clip";function ce(){h(a.title),l(!0)}async function ue(y){y?.preventDefault?.();let H=p.trim();if(!H||H===a.title){l(!1);return}try{await k(`/api/v1/clips/${encodeURIComponent(G)}`,{method:"PATCH",body:{title:H}}),n(m=>({...m,title:H})),l(!1),v("Title saved.")}catch(m){v(m.message)}}function ae(){w(a.description||""),f(!0)}async function ne(){let y=g.trim();try{await k(`/api/v1/clips/${encodeURIComponent(G)}`,{method:"PATCH",body:{description:y||null}}),n(H=>({...H,description:y||null})),f(!1),v("Description saved.")}catch(H){v(H.message)}}async function Ce(y,{force:H=!1}={}){let m=a.visibility;if(!(m===y&&!H)){n($=>({...$,visibility:y}));try{let $=await k(`/api/v1/clips/${encodeURIComponent(G)}/visibility`,{method:"POST",body:{visibility:y}});n(M=>({...M,visibility:$.visibility,public_url:$.public_url,public_share_id:$.public_share_id})),v(`Visibility set to ${y}.`,{actionLabel:"Undo",onAction:()=>Ce(m,{force:!0})})}catch($){n(M=>({...M,visibility:m})),v($.message)}}}async function oe(){if(te)try{await navigator.clipboard.writeText(te),v("Link copied.")}catch{v("Couldn't copy the link.")}}async function be(){D(!1);try{await k(`/api/v1/clips/${encodeURIComponent(G)}`,{method:"DELETE"}),v("Clip deleted."),K("/library")}catch(y){v(y.message)}}let Te=[a.game_name&&s`<a class="chip chip-on" href=${`/game/${encodeURIComponent(a.game_category_id||a.game_name)}`}>${a.game_display_name||a.game_name}</a>`,Pe(a.view_count),`Recorded ${J(a.recorded_at)}`].filter(Boolean),fe=jr(i,A,8);return s`<main class="page watch">
    <div>
      ...
      ${Y&&s`<div class="watch-actions">
        <div class="seg" role="radiogroup" aria-label="Visibility">
          ${Fr.map(y=>s`<button type="button" role="radio" key=${y} aria-checked=${a.visibility===y}
              class=${`seg-item ${a.visibility===y?"seg-on":""}`} onClick=${()=>Ce(y)}
              >${y[0].toUpperCase()+y.slice(1)}</button>`)}
        </div>
        <button type="button" class="btn btn-primary" disabled=${!te} onClick=${oe}>
      ...
      <div class="watch-desc">
        ${u?s`<textarea class="input" rows="5" value=${g} autofocus
              onInput=${y=>w(y.target.value)} onBlur=${ne}
              onKeyDown=${y=>{y.key==="Enter"&&(y.ctrlKey||y.metaKey)&&ne(),y.key==="Escape"&&f(!1)}}></textarea>`:a.description?s`<p>${a.description}
              ${Y&&s`<button type="button" class="edit-pencil" aria-label="Edit description" onClick=${ae}
                >${C("edit",{size:12})}</button>`}</p>`:Y?s`<button type="button" class="watch-desc-add" onClick=${ae}>+ Add a description</button>`:""}
      </div>
  ...
  </div>`}function mn(){let{user:e}=Z(N),[t,a]=b(""),[n,r]=b(""),[o,i]=b(""),[c,d]=b(!1);if(E(()=>{e&&K("/library")},[e]),e)return null;async function l(p){if(p.preventDefault(),!c){d(!0),i("");try{let h=await k("/api/v1/auth/login",{method:"POST",body:{username:t,password:n}});ve(h.csrf_token),N.set({user:h.user,csrfToken:h.csrf_token,ready:!0}),K("/library")}catch(h){i(h instanceof $e?h.message:"Sign in failed"),d(!1)}}}return s`<${pt} titleId="login-title">
  ...
  </${pt}>`}se();function Fe({label:e,value:t,sub:a,meter:n,tone:r}){let o=r?` stat-${r}`:"";return s`<div class="stat-card">
  ...
  </div>`}function Xr(e){let t=Number(e?.global_storage_warning_threshold_bytes||0);if(!t)return null;let a=Number(e?.total_storage_bytes||0);return Math.max(0,Math.min(1,a/t))}function eo(e){if(!e?.global_storage_warning_threshold_bytes)return"Disabled";let t=F(e.global_storage_warning_threshold_bytes);return e.global_storage_warning?`At or above ${t}`:`Below ${t}`}function to({deadJobs:e=[],failedUploads:t=[]}={}){let a=e.length+t.length;return{failedCount:a,healthy:a===0}}function ee(e,t){return s`<div><dt>${e}</dt><dd>${t??"Unknown"}</dd></div>`}function _n({overview:e,deadJobs:t,failedUploads:a}){let n=Xr(e),{failedCount:r,healthy:o}=to({deadJobs:t,failedUploads:a}),i=e.global_storage_warning_threshold_bytes;return s`<div>
    <div class="stat-grid">
    ...
    <div class="panel">
      ...
      <dl class="ad-kv">
        ...
        ${ee("Stored clips",`${e.total_clips} clips \u2014 ${F(e.total_storage_bytes)}`)}
        ${ee("Users",`${e.total_users} total`)}
        ${ee("Max upload",F(e.max_upload_size_bytes))}
        ${ee("Part size",F(e.upload_part_size_bytes))}
        ${ee("Single PUT max",F(e.single_put_max_bytes))}
        ${ee("Active uploads/user",e.max_active_upload_sessions_per_user)}
        ${ee("User quota",e.user_storage_quota_bytes?F(e.user_storage_quota_bytes):"Disabled")}
        ${ee("Storage warning",eo(e))}
  ...
  </div>`}se();function mt(e){let t=String(e||"").trim();return t||null}function ao(e,t){return!(e.is_disabled||t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function no(e,t){return!(!e.is_disabled||t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function ro(e,t){return t?.role==="owner"&&e.role!=="owner"&&t?.id!==e.id}function oo(e,t){return!(t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function Ot(e){return e?[["user","User"],["admin","Admin"]]:[["user","User"]]}function so({isOwner:e,onCreated:t}){let[a,n]=b(!1);async function r(o){if(o.preventDefault(),a)return;n(!0);let i=o.currentTarget,c=new FormData(i);try{await k("/api/v1/users",{method:"POST",body:{username:String(c.get("username")||""),display_name:mt(c.get("display_name")),email:mt(c.get("email")),password:mt(c.get("password")),role:String(c.get("role")||"user")}}),v("User created."),i.reset(),t()}catch(d){v(d.message)}finally{n(!1)}}return s`<form class="panel section" onSubmit=${r}>
    <h2>Create user</h2>
  ...
  </form>`}function lo({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",a=e.username?` for ${e.username}`:"",n=async()=>{try{await navigator.clipboard.writeText(e.reset_url),v("Copied to clipboard.")}catch{v("Copy failed. Select and copy the URL manually.")}};return s`<div class="notice admin-reset-link">
    <div>
  ...
  </div>`}function co(e){return e.is_disabled?s`<span class="badge badge-warn">Disabled</span>`:s`<span class="badge badge-public">Active</span>`}function uo(e){return e?e.user_storage_quota_bytes!=null&&e.user_storage_quota_bytes>0?e.user_storage_quota_bytes:e.user_storage_quota_env_fallback_bytes??null:null}function po(e,t){if(e.storage_quota_bytes!=null&&e.storage_quota_bytes>0)return F(e.storage_quota_bytes);let a=uo(t);return a!=null&&a>0?`Default (${F(a)})`:"No limit"}function mo({user:e,currentUser:t,settings:a,onQuota:n,onReset:r,onDisable:o,onEnable:i,onRole:c,onPurge:d}){let l=po(e,a),p=!ao(e,t),h=!no(e,t),u=!oo(e,t),f=ro(e,t),[g,w]=b(e.role);return E(()=>{w(e.role)},[e.role]),s`<tr>
    <td>
    ...
    <div class="admin-users-forms">
      <${so} isOwner=${d} onCreated=${()=>{r(null),o()}} />
      <${io} isOwner=${d} smtpEnabled=${l}
        onCreated=${f=>{r(f),o()}} />
    </div>
    <div class="panel admin-users-table">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(f=>s`<${mo} key=${f.id} user=${f} currentUser=${a} settings=${t}
  ...
  </form>`}se();function fo(e){return`${(e/100).toFixed(e%100===0?0:1)}%`}function _o(e){switch(e){case"delete_and_retry":return"delete the failed upload and retry from a new session";case"retry":return"retry the current upload request";default:return""}}function ho({upload:e}){let t=Math.max(0,Math.min(1e4,Number(e.progress_basis_points||0))),a=_o(e.recovery_action);return s`<div class="job-item">
    <div class="job-title-line">
      <strong class="mono">${e.id}</strong>
      <span class="badge badge-warn">${fo(t)}</span>
    </div>
    ...
    <${Ht} title="Failed uploads" items=${e} emptyLabel="No failed uploads."
      renderItem=${p=>s`<${ho} key=${p.id} upload=${p} />`} />
  ...
  </div>`}se();var yn={grid:{kind:"grid",label:"Category Grid",description:"Portrait artwork used for this category on the Games page."},video:{kind:"hero",label:"Video Art",description:"Wide artwork shown subtly behind video titles and metadata."},icon:{kind:"icon",label:"Icon",description:"Compact artwork used in Library filters and category management."}};function wn(e,t,a){return`/api/v1/admin/game-categories/steamgriddb/games/${encodeURIComponent(e)}/artwork/${encodeURIComponent(t)}/${encodeURIComponent(a)}/preview`}function bo({displayName:e,steamGameId:t,selectedArtworks:a}){return{display_name:e,steamgriddb_game_id:t||null,grid_artwork_id:a?.grid?.id||null,video_artwork_id:a?.video?.id||null,icon_artwork_id:a?.icon?.id||null}}function go(e,t){return t?e?.steamgriddb_game_id?"Matched":"Not matched":"Not configured"}function $o(e,t,a=""){let n=a.trim().toLocaleLowerCase();return(e||[]).filter(r=>r.id===t?!1:n?[r.display_name,...(r.reported_names||[]).map(o=>o.reported_name)].some(o=>String(o||"").toLocaleLowerCase().includes(n)):!0)}function kn(e){return`/admin/game-categories/${encodeURIComponent(e)}`}function Cn({data:e,reload:t,categoryId:a}){let n=e?.categories||[];if(a){let r=n.find(o=>o.id===a);return r?s`<${yo} key=${r.id} data=${e} reload=${t}
    ...
    ${n.length===0?s`<p class="muted">Categories appear automatically when clips report a game name.</p>`:s`<div class="table-wrap"><table class="lib-table admin-category-table">
        ...
        <tbody>${n.map(r=>s`<tr key=${r.id}>
          ...
          <td>${r.clip_count}</td>
          <td><span class=${`category-status ${r.steamgriddb_game_id?"is-matched":""}`}>${go(r,e?.steamgriddb_configured)}</span></td>
          <td><a class="btn" href=${kn(r.id)}>${C("edit",{size:14})} Edit</a></td>
        </tr>`)}</tbody>
      </table></div>`}
  </section>`}function vo({slot:e,config:t,steamGameId:a,selected:n,active:r,results:o,busy:i,error:c,onToggle:d,onClear:l,onSelect:p}){return s`<section class=${`category-artwork-slot artwork-slot-${e}`}>
  ...
  </section>`}function yo({data:e,reload:t,editing:a,categories:n}){let[r,o]=b(a.display_name),[i,c]=b(a.display_name),[d,l]=b(a.steamgriddb_game_id||null),[p,h]=b(!1),[u,f]=b([]),[g,w]=b(!1),[P,R]=b(""),[S,D]=b(null),[O,I]=b([]),[U,q]=b(!1),[V,Y]=b(""),[A,G]=b({grid:a.grid_artwork_id?{id:a.grid_artwork_id,kind:"grid",preview_url:a.grid_artwork_url}:null,video:a.video_artwork_id?{id:a.video_artwork_id,kind:"hero",preview_url:a.video_artwork_url}:null,icon:a.icon_artwork_id?{id:a.icon_artwork_id,kind:"icon",preview_url:a.icon_artwork_url}:null}),[_e,me]=b(""),[re,ke]=b(""),[te,X]=b(!1),[ce,ue]=b(null),[ae,ne]=b(!1),Ce=Xe(()=>$o(n,a.id,_e),[n,a.id,_e]),oe=n.find(m=>m.id===re)||null;E(()=>{if(!e?.steamgriddb_configured||!p||i.trim().length<2){f([]),w(!1),R("");return}let m=!1,$=i.trim();w(!0),R("");let M=setTimeout(async()=>{try{let L=await k(`/api/v1/admin/game-categories/steamgriddb/search?q=${encodeURIComponent($)}`);m||f(L||[])}catch(L){m||(f([]),R(L.message))}finally{m||w(!1)}},300);return()=>{m=!0,clearTimeout(M)}},[e?.steamgriddb_configured,p,i]),E(()=>{if(!d||!e?.steamgriddb_configured||!S){I([]),Y("");return}let m=yn[S].kind,$=!1;return q(!0),Y(""),k(`/api/v1/admin/game-categories/steamgriddb/games/${encodeURIComponent(d)}/artwork?kind=${encodeURIComponent(m)}`).then(M=>{$||I(M||[])}).catch(M=>{$||(I([]),Y(M.message))}).finally(()=>{$||q(!1)}),()=>{$=!0}},[e?.steamgriddb_configured,d,S]);function be(m){l(m.id),c(m.name),o(m.name),h(!1),f([]),D(null),I([]),G({grid:null,video:null,icon:null})}function Te(){l(null),G({grid:null,video:null,icon:null}),D(null),I([]),h(!0)}async function fe(m){if(m.preventDefault(),!(!a||te)){X(!0);try{await k(`/api/v1/admin/game-categories/${encodeURIComponent(a.id)}`,{method:"PATCH",body:bo({displayName:r,steamGameId:d,selectedArtworks:A})}),v("Game category updated."),await t()}catch($){v($.message)}finally{X(!1)}}}async function y(){let m=ce;if(ue(null),!(!m||te)){X(!0);try{await k(`/api/v1/admin/game-categories/${encodeURIComponent(m.category.id)}/reported-names/${encodeURIComponent(m.name.id)}/separate`,{method:"POST"}),v(`${m.name.reported_name} separated into its own category.`),await t()}catch($){v($.message),($.status===404||$.status===409)&&await t()}finally{X(!1)}}}async function H(){if(ne(!1),!(!a||!oe||te)){X(!0);try{await k(`/api/v1/admin/game-categories/${encodeURIComponent(a.id)}/merge`,{method:"POST",body:{destination_category_id:oe.id}}),v(`${a.display_name} merged into ${oe.display_name}.`),await t(),K(kn(oe.id))}catch(m){v(m.message),(m.status===404||m.status===409)&&await t()}finally{X(!1)}}}return s`<div class="admin-categories-page">
      ...
      <section class="category-settings-section">
        ...
        ${d&&s`<div class="category-artwork-slots">
          ${Object.entries(yn).map(([m,$])=>s`<${vo}
            ...
            busy=${S===m&&U}
            error=${S===m?V:""}
            onToggle=${()=>{q(S!==m),I([]),Y(""),D(M=>M===m?null:m)}}
            onClear=${()=>G(M=>({...M,[m]:null}))}
            onSelect=${M=>{G(L=>({...L,[m]:M})),D(null),I([]),q(!1)}} />`)}
        </div>`}
      </section>
      ...
      <section class="category-settings-section">
        ...
        <div class="category-reported-name-list">
          ${(a.reported_names||[]).map(m=>s`<div class="category-reported-name">
            ...
            ${a.reported_names.length>1&&s`<button class="btn" type="button" disabled=${te}
              onClick=${()=>ue({category:a,name:m})}>Separate</button>`}
          </div>`)}
        </div>
      </section>
  ...
  </div>`}var Sn=[["overview","server","Overview"],["users","users","Users"],["categories","film","Game categories"],["settings","sliders","Settings"],["jobs","alert","Jobs"]];function wo(e){return e?.role==="admin"||e?.role==="owner"}async function ko(e){let t={signal:e},[a,n,r,o,i,c,d]=await Promise.all([k("/api/v1/admin/overview",t),k("/api/v1/admin/settings",t),k("/api/v1/users",t),k("/api/v1/admin/game-categories",t),k("/api/v1/admin/uploads/failed?limit=50",t),k("/api/v1/admin/jobs/dead?limit=50",t),k("/api/v1/admin/jobs/recent-errors?limit=50",t)]);return{overview:a,settings:n,users:r,categories:o,failedUploads:i,deadJobs:c,recentErrors:d}}function xn({route:e}){let{user:t}=Z(N),a=wo(t),n=!!(t&&!a),r=Sn.some(([u])=>u===e.tab)?e.tab:"overview",[o,i]=b(null),[c,d]=b(0),{data:l,error:p}=Be(a?`admin:${c}`:null,ko),h=()=>d(u=>u+1);return E(()=>{n&&(v("Admin access required."),K("/library"))},[n]),a?s`<main class="page">
    <h1>Admin</h1>
  ...
  </main>`:null}se();function Tn(e){let t=String(e||"").trim();return t||null}async function Co(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let a=Mt();a&&t.set("X-CSRF-Token",a);let n=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),r=await n.json().catch(()=>({}));if(!n.ok)throw new Error(r.error||n.statusText||"Avatar upload failed");return r}function Pn(e){N.set({...N.get(),user:e})}function So({user:e}){let[t,a]=b(!1);async function n(r){if(r.preventDefault(),t)return;a(!0);let o=new FormData(r.currentTarget);try{let i=await k("/api/v1/me/profile",{method:"PATCH",body:{display_name:Tn(o.get("display_name")),bio:Tn(o.get("bio"))}});Pn(i),v("Profile saved.")}catch(i){v(i.message)}finally{a(!1)}}return s`<form class="profile-form" onSubmit=${n}>
    <label class="field"><span>Display name</span>
  ...
  </form>`}function xo({user:e}){let[t,a]=b(!1);async function n(r){if(r.preventDefault(),t)return;let o=r.currentTarget.elements.avatar?.files?.[0];if(!o){v("Choose an avatar image first.");return}a(!0);try{let i=await Co(o);Pn(i),v("Avatar uploaded.")}catch(i){v(i.message)}finally{a(!1)}}return s`<form class="profile-form" onSubmit=${n}>
  ...
  </main>`:null}se();async function To(e){let t={signal:e},[a,n]=await Promise.all([k("/api/v1/auth/sessions",t),k("/api/v1/auth/device-tokens",t)]);return{sessions:a,deviceTokens:n}}function Po({item:e,onRevoke:t}){return s`<div class="management-item">
    <div>
  ...
  </div>`}function Mo({item:e,onRevoke:t}){let a=!!e.revoked_at;return s`<div class="management-item">
    <div>
  ...
  </div>`}function Rn(){let[e,t]=b(0),{data:a,error:n}=Be(e,To),[r,o]=b(null),i=()=>t(d=>d+1);async function c(){let d=r;o(null);try{if(d.kind==="session"){if(await k(`/api/v1/auth/sessions/${encodeURIComponent(d.item.id)}`,{method:"DELETE",body:{}}),d.item.current){ve(null),N.set({user:null,csrfToken:null,ready:!0}),v("Current session revoked."),K("/login");return}v("Session revoked.")}else await k(`/api/v1/auth/device-tokens/${encodeURIComponent(d.item.id)}`,{method:"DELETE",body:{}}),v("Device token revoked.");i()}catch(l){v(l.message)}}return n?s`<main class="page"><${Q} name="alert" title="Couldn't load account data" body=${n.message} /></main>`:s`<main class="page">
    <h1>Account</h1>
    ...
    ${a?s`<div class="account-grid">
          ...
          <div class="panel">
            ...
            ${a.deviceTokens.length?s`<div class="management-list">${a.deviceTokens.map(d=>s`<${Mo} key=${d.id} item=${d}
  ...
  </main>`}var Un="Clipline is a self-hosted clip library for saved gameplay moments.";function _t(e,t){return s`<div><dt>${e}</dt><dd>${t}</dd></div>`}function Dn(){let{data:e}=ie("/api/v1/about",0,{about_text:Un}),t=e?.about_text||Un;return s`<main class="page">
    <h1>About</h1>
  ...
  </main>`}var Ro={publicLibrary:Nt,publicGame:Nt,games:Ga,library:Qa,clip:zt,public:zt,login:mn,resetPassword:fn,admin:xn,profile:Mn,account:Rn,publicUser:En,about:Dn},In=Ne(window.location.pathname,window.location.search).name;function Eo(){let e=Ia();In=e.name;let{ready:t,user:a}=Z(N),n=t&&Ea(e.name,a);if(E(()=>{n&&K("/login")},[n]),!t||n)return s`<div class="boot">Loading…</div>`;let r=Ro[e.name],o=e.name==="login"||e.name==="resetPassword";return s`<div class="ui" onClick=${Aa}>
    ${!o&&s`<${Na} active=${Et(e)} route=${e} />`}
    <${r} route=${e} />
    ${!o&&s`<${Ba} active=${Ua(e)} />`}
    <${za} />
  </div>`}window.addEventListener("clipline:unauthorized",()=>{ve(null),N.set({user:null,csrfToken:null,ready:!0}),Rt(In)||K("/login")});(async()=>{try{let t=await k("/api/v1/auth/me");ve(t.csrf_token),N.set({user:t.user,csrfToken:t.csrf_token,ready:!0})}catch{ve(null),N.set({user:null,csrfToken:null,ready:!0})}let e=document.querySelector("#app");e.textContent="",da(s`<${Eo} />`,e)})();
