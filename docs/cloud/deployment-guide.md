...
This is the friendly, step-by-step guide to deploying Clipline Cloud v1.3.2 with Docker Compose. For the
...
```text
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.2
```
...
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.2 docker compose up -d
...
```sh
BUILD_IMAGE=0 CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.2 deploy/compose/smoke.sh
```
