...
This is the friendly, step-by-step guide to deploying Clipline Cloud v1.3.3 with Docker Compose. For the
...
```text
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.3
```
...
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.3 docker compose up -d
...
```sh
BUILD_IMAGE=0 CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.3 deploy/compose/smoke.sh
```
